...
<head>
    ...
    <link rel="stylesheet" href="assets/src/jquery.typeahead.css">
...
?>
<select>
    <option value="webs" <?php echo $webs ?>>Webster Unabridged Dictionary</option>
	<option value="wiki" <?php echo $wiki ?>>Wiktionary</option>
	<option value="ddc" <?php echo $ddc ?>>Dictionary.com</option>
    <option value="wn" <?php echo $wn ?>>WordNet Dictionary</option>
	<option value="oe" <?php echo $oe ?>>Oxford Dictionary</option>
</select>
<div class="js-result-container"></div>
    <form id="form-user_v1" name="form-user_v1" action="<?php echo $dict_id; ?>" method="get">
    ...
    source: {
        user: {
            display: "word",
            href: "<?php echo $dict_id; ?>?wid={{word|slugify}}",
            ajax: function (query) {
                return {
                    type: "GET",
                    url: "fetch?did=<?php echo $dict_id; ?>",
                    path: "data.user",
                    data: {
                        q: "{{query}}"
                    },
