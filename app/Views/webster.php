    ...
    <?php if($meaning){ ?>
        <h1>
            <u id="word" style="color:#FF9900; text-align: center;">
                <a style="color:#FF9900; text-align: center;" href="/?did=webs&wid=<?php echo $cID; ?>">
                ...
                <?php
                    ...
                    foreach($meaning as $def => $defs){
                      ...
                      $row = $meaning[$def];
                        ...
                        echo '<li class="hide'.$num_rows.'" value="'.$num_rows.'"><input type="checkbox" name="chk" class="chk">'.str_replace( array('{{','}}') , array('<span style="color: #F0FF00;">','</span>')  , str_replace(array('[[',']]'),'',$row->definition)).'</li>';
                    }
                ?>
            </ul>
        </h1>
